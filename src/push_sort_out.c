...
/*   Updated: 2021/06/22 10:10:27 by jisokang         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../include/push_swap.h"

static int	range3_atob(t_stack *a, t_stack *b)
{
	int	arr_a[3];
...
static int	range3_btoa(t_stack *a, t_stack *b)
{
	int	arr_b[3];
